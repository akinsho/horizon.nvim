...
local function get_highlights(data, custom)
  ...
  return {
    ...
    ['CursorLineNr'] = { fg = theme.active_line_number_fg, bg = theme.cursorline_bg, bold = true },
    ['CursorLineSign'] = { link = 'CursorLine' },
    ['CursorLineFold'] = { link = 'CursorLine' },
    ['CurSearch'] = { bg = theme.string.fg, fg = 'white', bold = true },
    ...
    ['@lsp.typemod.variable.global'] = { fg = theme.constant.fg, bold = true },
