...
local function get_plugin_highlights(bg)
  ...
  return {
    ...
    navic = {
      { ['NavicIconsFile'] = { fg = theme.fg } },
      { ['NavicIconsModule'] = { fg = c.yelloworange } },
      { ['NavicIconsNamespace'] = { fg = theme.fg } },
      { ['NavicIconsPackage'] = { fg = theme.fg } },
      ...
      { ['NavicIconsString'] = { fg = c.yelloworange } },
      ...
      { ['NavicIconsOperator'] = { fg = theme.fg } },
